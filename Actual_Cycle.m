function [T,s,P,h] = Actual_Cycle(tempOutside,tempInside,deltaT,substance)
...
T = [T1,T2,T3_3b,T4,T5,T6,T1] - 273.15;
s = [s1,s2,s3_3b,s4,s5,s6,s1]./1000;
P = [P1,P2,P3,P4,P5,P6,P1]./1000;
h = [h1,h2,h3,h4,h5,h6,h1]./1000;
